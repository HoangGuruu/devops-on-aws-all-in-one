...
echo "3. Expose your app on NodePort 30080:"
echo "   kubectl expose deployment <name> --type=NodePort --port=80 --target-port=<app-port>"
echo "   kubectl patch svc <name> -p '{\"spec\":{\"ports\":[{\"port\":80,\"nodePort\":30080}]}}'"
echo "4. Access via ALB:"
